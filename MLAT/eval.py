...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default="./models_checkpoint3/", help='model checkpoint.')
    ...
    for encoder_layers, decoder_layers in [(3, 3)]:  # ,,(0,6),(2,2),
        ...
        filename = ["epoch_5checkpoint_resnet50_transformer_3_3_Res+MLAT+fusion.pth.tar"]
        for i in range(len(filename)):
            ...
            if args.decoder_mode == "transformer" or args.decoder_mode == "transformer_decoder":
